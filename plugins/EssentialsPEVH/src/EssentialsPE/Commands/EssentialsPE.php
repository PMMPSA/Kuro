        ...
        switch(count($args)){
            ...
            case 2:
                switch(strtolower($args[0])){
                    ...
                    case "version":
                    case "v":
                        $sender->sendMessage(TextFormat::YELLOW . "Bạn đang dùng " . TextFormat::AQUA . "EssentialsPE " . TextFormat::YELLOW . "Phiên bản" . TextFormat::GREEN . $sender->getServer()->getPluginManager()->getPlugin("EssentialsPE")->getDescription()->getVersion());
                        break;
                    default:
